...
void run_for_one_graph(const string& graphName, const string& fastqName, ofstream& writer) {
    ...
    string bit_parallel_scores_file = "../bit_parallel_scores/" + bit_parallel_file;
    string bit_parallel_time_file = "../bit_parallel_times/" + bit_parallel_file;
    string bit_parallel_memory_file = "../bit_parallel_memory_usage/" + bit_parallel_file;
    string graphFilePath = "../graphs/" + graphName;
    string fastqFilePath = "../graphs/" + fastqName;
	...
	} catch (const GraphCycleException& e) {
	    hasCycle = true;
	...
	double navarro_usage_in_kb = static_cast<double>(getPeakMemoryUsage()) / 1024.0;
